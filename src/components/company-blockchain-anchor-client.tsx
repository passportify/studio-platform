...
import { mockCompanyAnchors, mockEntityNames } from "@/lib/mock-data";
...
export function CompanyBlockchainAnchorClient() {
  ...
  return (
    <>
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Your Anchor Log</CardTitle>
                <CardDescription>Chronological record of your company's data anchoring events.</CardDescription>
            </CardHeader>
            <CardContent>
            <Table>
                <TableHeader>
