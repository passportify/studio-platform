...
export default function SupplierScoreboardPage() {
  return (
    <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
      ...
      <p className="text-muted-foreground max-w-4xl">
        A platform-wide overview of supplier performance based on compliance, responsiveness, and data quality. Use this board to monitor the health of the entire ecosystem.
      </p>
